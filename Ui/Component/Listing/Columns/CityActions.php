...
{
    const EDIT_PAGE_ROUTE       = 'regioncitypro/city/edit';
    const DELETE_PAGE_ROUTE     = 'regioncitypro/city/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                if (isset($item['city_id'])) {
                    $item[$name]['edit'] = [
                        'href'  => $this->urlInterface->getUrl(self::EDIT_PAGE_ROUTE, ['city_id' => $item['city_id']]),
                        'label' => __('Edit')
                    ];
